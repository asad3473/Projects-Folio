    ...
    <>
      <div className=' md:fixed  md:z-20 text-lime-50 w-[100%] sm:py-3   top-0 shadow-lg shadow-orange-500/40 bg-[#6b8ac83a]'>
        <div className=' flex  justify-between items-center w-[90%] mx-auto'>
          ...
          <ul className={`flex justify-around absolute bg-[#6b8ac83a]  z-10 gap-4 flex-col top-0 lg:flex-row   w-full md:static md:w-max md:bg-transparent left-0 items-center duration-500  ${show? ' ': 'top-[-100vh] md:flex md:flex-row'} `}>
            {/* Main navbar items */}
